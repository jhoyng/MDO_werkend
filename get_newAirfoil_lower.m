function [error] = get_newAirfoil_lower(x)
...
if airfoil
    foilSide_points = foilSide_points_RL;

else
    foilSide_points = foilSide_points_TL;
end
...
airfoil_Out = Xtl(:,2);% ; Xtl(:,2)];
reference_Out = foilSide_points(:,2);% ;  foilSide_points_RL(:,2)];
%disp([airfoil_Out reference_Out])
